...
import { MAX_NAME_LENGTH } from "@/app/lib/user";
...
const ERROR_MESSAGES: Record<string, string> = {
  vazio: "Conta como vamos te chamar.",
  longo: `Nome muito longo (máx ${MAX_NAME_LENGTH} caracteres).`,
};
